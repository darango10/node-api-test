...
export class SalesController {
  ...
  async createSell(
    ...
    try {
      ...
      const { symbol, quantity } = (req as Request & { validatedSellBody?: { symbol: string; quantity: number } }).validatedSellBody!;
  ...
  private validateSellRequest(req: Request): string | null {
    ...
    (req as Request & { validatedSellBody?: z.infer<typeof sellRequestBodySchema> }).validatedSellBody = parsed.data;
    return null;
  }
